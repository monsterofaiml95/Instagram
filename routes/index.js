...
const localStrategy=require('passport-local');//Allow to make account on the basis of username and password
const upload=require('./multer')

passport.use(new localStrategy(userModel.authenticate()))//Make user remain login
